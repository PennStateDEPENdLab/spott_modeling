...
% LL path
project_repo = '/proj/mnhallqlab/projects/spott_modeling/outputs/par_sim_exp_full';
...
for mnum = 1:length(models)
    ...
    vo.output_dir = ['/proj/mnhallqlab/projects/spott_modeling/outputs', '/par_vba_out_full_ffx/', vo.dataset, '/', vo.model];

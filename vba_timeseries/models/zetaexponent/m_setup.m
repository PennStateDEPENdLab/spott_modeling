...
vo.obs_fname = @m_suuvid_obs_zetaexponent;
...
vo.phi_names = {'beta', 'gamma', 'nu', 'kappa', 'omega'};
...
priors.SigmaPhi = [10,10,10,1,10].*eye(vo.n_phi); %variance of 10 on all except kappa (gamma inverse cdf transform)

...
vo.obs_fname = @suuvid_obs_nonu_nobeta;

vo.beta = 150; %rather than a free parameter
...
vo.phi_names = {'gamma', 'kappa', 'omega'};
...
priors.SigmaPhi = [10,1,10].*eye(vo.n_phi); %variance of 10 on all except kappa (gamma inverse cdf transform)
